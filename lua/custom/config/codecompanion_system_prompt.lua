-- Module that exports the system prompt string for CodeCompanion
-- Keeps the large system prompt in a single place so it can be reused.
--
-- Usage:
-- local system_prompt = require("custom.config.codecompanion_system_prompt")
-- -- then set in your plugin config:
